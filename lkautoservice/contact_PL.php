  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid head-cont">
      ...
      <ul class="nav navbar-nav">
        <li><a href="home_PL.php">Home</a></li>
        <li class="dropdown">
        ...
        <li class="active"><a href="contact_PL.php">Skontaktuj się</a></li>
      </ul>
    </div>
  </nav>
  <div class="headpic">
...
<main class="container">
    <h3 id="heading">Jeśli masz jeszcze jakieś zapytania, zostaw nam wiadomość!</h3>
...
<form id="contact_form" action="mail.php">
  <label for="fname"><h3 class="contact_titles">Twoje imie:</h3></label><br>
  <input type="text" class="nameemail" name="fname"><br><br>

  <label for="fname"><h3 class="contact_titles">Twój e-mail:</h3></label><br>
  <input type="text" class="nameemail" name="fname"><br><br>

  <label for="fname"><h3 class="contact_titles">Wiadomość:</h3></label><br>
